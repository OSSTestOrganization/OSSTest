...
{
	public partial class DictionaryPropertyUserControl : PropertyUserControl
	{
		private int _origY;
		public DictionaryPropertyUserControl(Property property) : base(property)
		{
			InitializeComponent();

			labelOfProperty.Text = property.DisplayName + " (dictionary list)";
